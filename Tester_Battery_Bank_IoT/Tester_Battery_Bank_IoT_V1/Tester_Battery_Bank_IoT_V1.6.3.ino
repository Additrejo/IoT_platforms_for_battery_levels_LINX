//Actualizaciones, se corrigió factor de calibración y el inicio es cargando la batería.
...
// Estado del sistema
bool enCarga = true;  // Inicia en modo de carga
...
void setup() {
    ...
    digitalWrite(releCarga, HIGH);    // Activar carga al inicio
...
void loop() {
    ...
    static bool previoEnCarga = true;
